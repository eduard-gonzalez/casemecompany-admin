      ...
      <div className="w-100 position-relative">
        ...
        <div className="Typeahead Typeahead--twitterUsers">
          <div className="u-posRelative" ref={ref}>
            <Input value={input} className="demo-input Typeahead-input form-control-plaintext w-100" type="text" placeholder={t("Buscar ...") + ".."} name="search-bar" title="searchbar" onChange={handleChange} />
