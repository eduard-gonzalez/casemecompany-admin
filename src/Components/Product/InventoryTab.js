...
const InventoryTab = ({ values, setFieldValue, errors, updateId }) => {
  ...
  return (
    <>
        ...
        nameList={[
          {
            ...
            inputprops: {
              ...
              options: [
                ...
                { id: "classified", name: "Variable" },
              ],
            },
          },
        ]}
      />
      <CheckBoxField name="is_external" title="Es externo" />
        {values['is_external'] && 
            <SimpleInputField 
              nameList={[
      ...
      <SimpleInputField nameList={[{ name: "unit", placeholder: t("EnterUnit(e.g10pieces)"), helpertext: "*Especifique la unidad de este producto." }, {
        name: "weight", type: "number", placeholder: t("EnterweightGms(e.g100)"), helpertext: "*Es necesario para el cálculo del envío."
      }]} />
